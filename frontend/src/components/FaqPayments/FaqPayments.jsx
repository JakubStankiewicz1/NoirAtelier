          ...
          <div className="faqPaymentsContainerLeftContainer">
            ...
            <div className="faqPaymentsContainerLeftContainerMiddle">
              <div className="faqPaymentsContainerLeftContainerMiddleContainer">
                <p className="faqPaymentsContainerLeftContainerMiddleContainerText">
                  Experience seamless and secure payment processing with Noir
                  Atelier. We accept all major payment methods and provide
                  flexible financing options to make your luxury property
                  investment as smooth as possible. Our encrypted payment system
                  ensures your financial information remains completely
                  protected.
                </p>
              </div>
            </div>
            ...
            <div className="faqPaymentsContainerLeftContainerBottom">
              <div className="faqPaymentsContainerLeftContainerBottomContainer">
                <img
                  src={assets.FaqPaymentsOne}
                  alt=""
                  className="faqPaymentsContainerLeftContainerBottomContainerIcon"
                />
                <img
                  src={assets.FaqPaymentsTwo}
                  alt=""
                  className="faqPaymentsContainerLeftContainerBottomContainerIcon"
                />
                <img
                  src={assets.FaqPaymentsThree}
                  alt=""
                  className="faqPaymentsContainerLeftContainerBottomContainerIcon"
                />
                <img
                  src={assets.FaqPaymentsFour}
                  alt=""
                  className="faqPaymentsContainerLeftContainerBottomContainerIcon"
                />
                <img
                  src={assets.FaqPaymentsFive}
                  alt=""
                  className="faqPaymentsContainerLeftContainerBottomContainerIcon"
                />
              </div>
            ...
            <div className="faqPaymentsContainerRightContainerMiddle">
              <div className="faqPaymentsContainerRightContainerMiddleContainer">
                <p className="faqPaymentsContainerRightContainerMiddleContainerText">
                  Your trust is our priority. We utilize industry-leading
                  security protocols and encryption technology to safeguard
                  every transaction, ensuring complete peace of mind for all
                  your luxury property investments.
                </p>
              </div>
            </div>
            {/* Bottom Part */}
              ...
              <div className="faqPaymentsContainerRightContainerBottomContainer">
                  ...
                  <div className="faqPaymentsContainerRightContainerBottomContainerOneThree">
                    <div className="faqPaymentsContainerRightContainerBottomContainerOneThreeContainer">
                      <p className="faqPaymentsContainerRightContainerBottomContainerOneThreeContainerText">
                        Experience lightning-fast payment processing with
                        real-time confirmation for all your luxury property
                        transactions.
                      </p>
                    </div>
                  </div>
                ...
                <div className="faqPaymentsContainerRightContainerBottomContainerOne">
                  ...
                  <div className="faqPaymentsContainerRightContainerBottomContainerOneThree">
                    <div className="faqPaymentsContainerRightContainerBottomContainerOneThreeContainer">
                      <p className="faqPaymentsContainerRightContainerBottomContainerOneThreeContainerText">
                        Choose from multiple payment plans and financing
                        solutions tailored to meet your individual investment
