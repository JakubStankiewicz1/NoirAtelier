  ...
  const testimonials = [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1494790108755-2616b612b1a8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
    ...
    <div className="buySellSupportTestimonials">
      <div className="buySellSupportTestimonialsContainer">
        ...
        <div className="buySellSupportTestimonialsHeader">
          <p className="buySellSupportTestimonialsHeaderSubtitle cormorant-garamond-regular">
            Opinie Klientów
          </p>
          ...
          <p className="buySellSupportTestimonialsHeaderDescription">
            Poznaj doświadczenia naszych klientów, którzy powierzyli nam proces
            kupna lub sprzedaży swoich nieruchomości. Ich satysfakcja to
            najlepsza rekomendacja naszych usług.
          </p>
        </div>
        ...
        <div className="buySellSupportTestimonialsStats">
          <div className="buySellSupportTestimonialsStatsContainer">
            <div className="buySellSupportTestimonialsStatItem">
              <div className="buySellSupportTestimonialsStatNumber cormorant-garamond-regular">
                98%
              </div>
              <div className="buySellSupportTestimonialsStatLabel">
