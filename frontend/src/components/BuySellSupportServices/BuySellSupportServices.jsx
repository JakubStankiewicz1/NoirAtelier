  ...
  const buyServices = [
    {
      ...
      description:
        "Profesjonalne wyszukiwanie nieruchomości zgodnych z Twoimi kryteriami i budżetem.",
    ...
    },
    {
      ...
      description:
        "Szczegółowa analiza wartości rynkowej i potencjału inwestycyjnego nieruchomości.",
    ...
    },
    {
      ...
      description:
        "Profesjonalne prowadzenie negocjacji cenowych i przygotowanie dokumentacji.",
    ...
    },
    {
      ...
      description:
        "Kompleksowe zabezpieczenie procesu kupna przed ryzykami prawno-finansowymi.",
      features: [
  ...
  const sellServices = [
    {
      ...
      description:
        "Profesjonalna wycena Twojej nieruchomości z analizą konkurencji rynkowej.",
    ...
    },
    {
      ...
      description:
        "Kompleksowe przygotowanie nieruchomości do prezentacji potencjalnym nabywcom.",
      features: [
        "Home staging",
        "Sesja fotograficzna",
    ...
    },
    {
      ...
      description:
        "Skuteczna promocja nieruchomości w mediach i kanałach sprzedażowych.",
      features: [
        "Kampanie reklamowe",
    ...
    },
    {
      ...
      description:
        "Profesjonalne przeprowadzenie procesu sprzedaży od oferty do przekazania kluczy.",
      features: [
        "Kwalifikacja kupców",
        "Finalizacja umów",
      ...
      <div className="buySellSupportServicesContainer">
        ...
        <div className="buySellSupportServicesHeader">
          <div className="buySellSupportServicesHeaderContent">
            <p className="buySellSupportServicesHeaderSubtitle cormorant-garamond-regular">
              Nasze Usługi
            </p>
            <h2 className="buySellSupportServicesHeaderTitle cormorant-garamond-regular">
              Kompleksowe Wsparcie w{" "}
              <span className="highlight">Kupnie i Sprzedaży</span>
            </h2>
            <p className="buySellSupportServicesHeaderDescription">
              Oferujemy pełen zakres usług związanych z kupnem i sprzedażą
              nieruchomości premium. Nasz doświadczony zespół zapewni Ci
              profesjonalne wsparcie na każdym etapie transakcji.
            </p>
          </div>
        </div>
        ...
        <div className="buySellSupportServicesSection">
          <div className="buySellSupportServicesSectionHeader">
            ...
            <div className="buySellSupportServicesSectionTitleContainer">
              <h3 className="buySellSupportServicesSectionTitle cormorant-garamond-regular">
                Usługi dla Kupujących
              </h3>
              <p className="buySellSupportServicesSectionDescription">
                Pomożemy Ci znaleźć idealną nieruchomość i przeprowadzimy Cię
                przez cały proces zakupu
              </p>
            </div>
          </div>
            ...
            {buyServices.map((service, index) => (
              <div key={index} className="buySellSupportServicesCard">
                ...
                <div className="buySellSupportServicesCardContent">
                  <h4 className="buySellSupportServicesCardTitle cormorant-garamond-regular">
                    {service.title}
                  </h4>
                  <p className="buySellSupportServicesCardDescription">
                    {service.description}
                  </p>
                  <ul className="buySellSupportServicesCardFeatures">
                    {service.features.map((feature, featureIndex) => (
                      <li
                        key={featureIndex}
                        className="buySellSupportServicesCardFeature"
                      >
        ...
        <div className="buySellSupportServicesSection">
          <div className="buySellSupportServicesSectionHeader">
            ...
            <div className="buySellSupportServicesSectionTitleContainer">
              <h3 className="buySellSupportServicesSectionTitle cormorant-garamond-regular">
                Usługi dla Sprzedających
              </h3>
              <p className="buySellSupportServicesSectionDescription">
                Skutecznie sprzedamy Twoją nieruchomość w najlepszej możliwej
                cenie i czasie
              </p>
            </div>
          </div>
