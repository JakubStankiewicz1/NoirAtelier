...
import { FaKey, FaBell, FaWifi, FaCar, FaSwimmer, FaUtensils, FaHome, FaShieldAlt } from 'react-icons/fa';
  ...
  const services = [
    {
      ...
      description: "Luksusowe apartamenty i wille na krótkie pobyty z pełnym wyposażeniem premium."
    },
    {
      id: 2,
      icon: <FaHome />,
      title: "Wynajem Długoterminowy",
      description: "Ekskluzywne nieruchomości na dłuższe okresy z elastycznymi warunkami najmu."
    },    {
      id: 3,
      icon: <FaBell />,
      title: "Usługi Concierge",
      description: "Całodobowa obsługa concierge zapewniająca najwyższy standard obsługi klienta."
    },
    {
      id: 4,
      icon: <FaShieldAlt />,
      title: "Pełne Ubezpieczenie",
      description: "Kompleksowe ubezpieczenie nieruchomości i odpowiedzialności cywilnej."
    },
    {
      id: 5,
      icon: <FaWifi />,
      title: "Premium Amenities",
      description: "Najwyższej klasy udogodnienia: internet, TV, sprzęt kuchenny i wiele więcej."
    },
    {
      id: 6,
      icon: <FaCar />,
      title: "Parking & Transport",
      description: "Bezpieczne miejsca parkingowe i usługi transportowe na życzenie."
    }
  ];
        ...
        <div className="luxuryRentalsServicesHeader">
          <div className="luxuryRentalsServicesHeaderContainer">
            ...
            <p className="luxuryRentalsServicesHeaderDescription">
              Oferujemy kompleksowe usługi wynajmu luksusowych nieruchomości z najwyższym standardem obsługi
            </p>
          </div>
        </div>
          ...
          <div className="luxuryRentalsServicesFeaturesContainer">
            <div className="luxuryRentalsServicesFeaturesLeft">
              ...
              <ul className="luxuryRentalsServicesFeaturesList">
                <li><FaSwimmer /> Prywatne baseny i spa</li>
                <li><FaUtensils /> Prywatny szef kuchni na życzenie</li>
                <li><FaCar /> Luksusowe samochody do wynajęcia</li>
                <li><FaWifi /> Szybki internet i smart home</li>
              </ul>
            </div>
