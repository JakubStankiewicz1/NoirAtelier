    ...
    <div className="interiorDesignPortfolio">
      <div className="interiorDesignPortfolioContainer">
        ...
        <div className="interiorDesignPortfolioHeader">
          <div className="interiorDesignPortfolioHeaderContent">
            {" "}
            <span className="interiorDesignPortfolioHeaderBadge">
            ...
            <p className="interiorDesignPortfolioHeaderDescription">
              Odkryj naszą kolekcję wyjątkowych projektów wnętrz, które łączą
              funkcjonalność z niepowtarzalnym stylem. Każdy projekt to unikalna
        ...
        <div className="interiorDesignPortfolioFilters">
          {filters.map((filter) => (
            ...
            >
              <span className="interiorDesignPortfolioFilterIcon">
                {filter.icon}
              </span>
              <span className="interiorDesignPortfolioFilterLabel">
                {filter.label}
              </span>
            </button>
          ))}
          ...
          {filteredProjects.map((project, index) => (
            ...
            >
              <div className="interiorDesignPortfolioItemImage">
                ...
                <div className="interiorDesignPortfolioItemImageOverlay">
                  <div className="interiorDesignPortfolioItemImageOverlayContent">
                    ...
                    <div className="interiorDesignPortfolioItemImageOverlayBottom">
                      ...
                      <p className="interiorDesignPortfolioItemImageOverlayLocation">
                ...
                <div className="interiorDesignPortfolioItemImageHover">
                  {" "}
                  <button className="interiorDesignPortfolioItemImageHoverButton">
