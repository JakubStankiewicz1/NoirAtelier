...
const PropertyManagementTestimonials = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      image:
        "https://media.istockphoto.com/id/1353379051/photo/portrait-of-beautiful-mature-african-woman-looking-at-camera-outdoor.jpg?s=612x612&w=0&k=20&c=87IkLpQc2INpv2sJRrH347-qVrNFmH2QM_da8J46y44=",
  ...
  return (
    <div className="propertyManagementTestimonials">
      <div className="propertyManagementTestimonialsContainer">
        {/* Header */}{" "}
        <div className="propertyManagementTestimonialsHeader">
          <p className="propertyManagementTestimonialsHeaderSubtitle cormorant-garamond-regular">
            Client Reviews
          </p>
          <h2 className="propertyManagementTestimonialsHeaderTitle cormorant-garamond-regular">
            What Our Clients Say About Us
          </h2>
          <p className="propertyManagementTestimonialsHeaderDescription">
            Discover the opinions of property owners who trusted our experience
            and professionalism
          </p>
        </div>
        {/* Testimonials Slider */}
        <div className="propertyManagementTestimonialsSlider">
              ...
              >
                <div className="propertyManagementTestimonialsSliderItemContent">
                  <div className="propertyManagementTestimonialsSliderItemQuote">
                    <svg width="40" height="30" viewBox="0 0 40 30" fill="none">
                      <path
                        d="M0 15C0 6.7 6.7 0 15 0h10v15H15c-2.8 0-5 2.2-5 5s2.2 5 5 5h5v10H15C6.7 30 0 23.3 0 15z"
                        fill="#AC6620"
                      />
                      <path
                        d="M20 15C20 6.7 26.7 0 35 0h5v15H35c-2.8 0-5 2.2-5 5s2.2 5 5 5h5v10h-5C26.7 30 20 23.3 20 15z"
                        fill="#AC6620"
                      />
                    </svg>
                  </div>
                  ...
                  <div className="propertyManagementTestimonialsSliderItemRating">
                    {Array.from({ length: testimonial.rating }, (_, i) => (
                      <FaStar
                        key={i}
                        className="propertyManagementTestimonialsSliderItemStar"
                      />
                    ))}
                  </div>
                </div>
                <div className="propertyManagementTestimonialsSliderItemAuthor">
                  ...
                  <div className="propertyManagementTestimonialsSliderItemAuthorInfo">
                    ...
                    <p className="propertyManagementTestimonialsSliderItemAuthorLocation">
          ...
          {/* Navigation */}{" "}
          <div className="propertyManagementTestimonialsSliderNavigation">
            <button
        ...
        {/* Stats */}{" "}
        <div className="propertyManagementTestimonialsStats">
          <div className="propertyManagementTestimonialsStatsItem">
            <h3 className="propertyManagementTestimonialsStatsItemNumber cormorant-garamond-regular">
              98%
            </h3>
            <p className="propertyManagementTestimonialsStatsItemLabel">
              Satisfied Clients
            </p>
          </div>
          <div className="propertyManagementTestimonialsStatsItem">
