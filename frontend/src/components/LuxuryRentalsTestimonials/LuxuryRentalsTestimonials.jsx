  ...
  const testimonials = [
    {
      ...
      location: "Warszawa",
      rating: 5,
      comment: "Niesamowite doświadczenie! Apartament był dokładnie taki, jak na zdjęciach - luksusowy, czysty i perfekcyjnie wyposażony. Obsługa concierge była dostępna 24/7 i zawsze pomocna. Zdecydowanie polecam!",
      image: "https://images.unsplash.com/photo-1494790108755-2616b612b043?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=200&q=80",
    ...
    },
    {
      ...
      location: "Kraków",
      rating: 5,
      comment: "Wynajmowałem penthouse na 6 miesięcy podczas relokacji do Krakowa. Wszystko było zorganizowane perfekcyjnie - od dokumentów po codzienną obsługę. Widok z tarasu był spektakularny!",
    ...
    },
    {
      ...
      location: "Sopot",
      rating: 5,
      comment: "Willa nad morzem przekroczyła wszystkie nasze oczekiwania. Prywatny basen, piękny ogród i dostęp do plaży - to było jak wakacje przez cały rok. Profesjonalna obsługa na najwyższym poziomie.",
    ...
    },
    {
      ...
      location: "Gdańsk",
      rating: 5,
      comment: "Loft w Starym Mieście był idealny dla moich potrzeb biznesowych. Nowoczesne wyposażenie, szybki internet i świetna lokalizacja. Wszystkie szczegóły były dopracowane do perfekcji.",
    ...
    },
    {
      ...
      location: "Zakopane",
      rating: 5,
      comment: "Willa w Zakopanem była miejscem, gdzie mogłam w pełni się zrelaksować i skupić na twórczości. Widok na Tatry, sauna i kominek - wszystko czego potrzebowałam. Obsługa bardzo dyskretna i profesjonalna.",
      ...
      <div className="luxuryRentalsTestimonialsContainer">
        ...
        <div className="luxuryRentalsTestimonialsHeader">
          <div className="luxuryRentalsTestimonialsHeaderContainer">
            <p className="luxuryRentalsTestimonialsHeaderSubtitle">Opinie Klientów</p>
            ...
            <p className="luxuryRentalsTestimonialsHeaderDescription">
              Poznaj opinie naszych zadowolonych klientów o luksusowych nieruchomościach do wynajmu
            </p>
          </div>
        </div>
